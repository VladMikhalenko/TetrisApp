...
{
private:
	HANDLE mConsole;//дескриптор вывода в консоль
	HANDLE mConsoleIn;//дескриптор ввода в консоль

	CHAR_INFO* mChiBuffer;//буфер дл€ чтени€и записи в/из консоли
	COORD mDwBufferSize;//размер буфера дл€ рисовани€??
	COORD mDwBufferCoord;//позици€ рисовани€
	SMALL_RECT mLpWriteRegion;//определ€ет координаты топ лефт и ботом райт точек пр€моугльдника
...
public:
	...
	//действие, которое будет проихсодит каждую секунду, можно переопределить в наследниках
	virtual void OneSecondAction();
